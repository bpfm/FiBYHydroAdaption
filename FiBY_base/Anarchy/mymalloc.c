...
void mymalloc_init(void)
{
  ...
  Table = (char **) malloc(MAXBLOCKS * sizeof(char *));

#ifdef PEDANTIC_MEMORY_CEILING
  n = (size_t) (PEDANTIC_MEMORY_CEILING * 1024.0 * 1024.0);
...
void *mymalloc(size_t n)
{
  ...
  if(n > FreeBytes)
    {
      printf("Task=%d: Not enough memory in mymalloc(n=%g MB).  FreeBytes=%g MB  AllocatedBytes=%g MB.\n",
